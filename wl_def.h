...
#include <netinet/in.h>		/* for in_addr_t type */
...
//
// Door stuff: we must refresh the connection tracking stuff
// only if we open a new door
//
#define DOOR_REFRESH 0
#define DOOR_LOOP 1
...
//--------------------
//
// Connection tracking stucture
//
//--------------------
typedef struct conntrack_t
{
...
void OpenDoor (int door, int ctx_door_refresh);
